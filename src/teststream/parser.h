...
public:
  ...
  void GetVideoInformation(int &FpsScale, int &FpsRate, int &Height, int &Width, float &Aspect);

  /* Audio Stream Information */
  bool SetAudioInformation(int Channels, int SampleRate, int BitRate, int BitsPerSample, int BlockAlign);
  void GetAudioInformation(int &Channels, int &SampleRate, int &BitRate, int &BitsPerSample, int &BlockAlign);
